...
(18, ' Nico', 'Fraga', 'Buenos Aires', 'Argentina', '8eb1e12afb056be91abc4545f45420ba', 'PHP,Laravel,Flutter,CSS', '{\"facebook\":\"https://facebook.com/C%C3%B3digo-Con-Juan-103341632130628\",\"twitter\":\"https://twitter.com/codigoconjuan\",\"youtube\":\"https://youtube.com/codigoconjuan\",\"instagram\":\"\",\"tiktok\":\"\",\"github\":\"\"}');

INSERT INTO `usuarios` (`id`, `nombre`, `apellido`, `email`, `password`, `confirmado`, `token`, `admin`) VALUES
(10, 'Tomas', 'Sargentoni', 'correo@correo.com', '$2y$10$PZmkyT5plWauX/bEYT10qOYNpt4Ud0TFTKBcZtdjI9MmvFaKJZzLi', 1, '', 1);
