<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <label for="descripcion" class="formulario__label">Nombre Evento</label>
        <textarea class="formulario__input" id="descripcion" name="descripcion" placeholder="Descripcion Evento" rows="8" ><?php echo $evento->nombre; ?></textarea>
    </div>
        ...
        <div class="formulario__radio">
            <?php foreach($dias as $dia) { ?>
                <div>
                    ...
                    <input
                        type="radio" id="<?php echo strtolower($dia->nombre); ?>" name="dia" value="<?php echo $dia->id; ?>" <?php echo ($evento->dia_id === $dia->id) ? "checked" : ""; ?>>
                </div>
            <?php } ?>
        </div>
